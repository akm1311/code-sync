        ...
        try {
            ...
            if (config.isVercelBlob) {
                ...
                try {
                    ...
                    console.error(
                        "[UPLOAD] Blob upload failed, falling back to server upload:",
                        blobError
                    );
                ...
                <div className="max-w-4xl mx-auto px-4 py-4">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center space-x-4">
                            ...
                            <Badge
                                variant="outline"
                                className="px-3 py-1.5 bg-emerald-50 dark:bg-emerald-900/20 border-emerald-200 dark:border-emerald-800 text-emerald-700 dark:text-emerald-300"
                            >
                    ...
                    <div className="flex items-start space-x-3">
                        ...
                        <div>
                            ...
                            <p className="text-blue-800 dark:text-blue-200 text-sm leading-relaxed">
                                Type or paste your code below - it instantly
                                syncs across all your devices! Share the URL
                                with others to collaborate in real-time. No
                                sign-up needed.
                            </p>
                        </div>
                    </div>
                        ...
                        <Card className="bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700 shadow-sm">
                            ...
                            <div className="relative">
                                <CodeMirror
                                    ...
                                    className="overflow-hidden rounded-md border border-slate-200 dark:border-slate-700 text-base"
                                />
                                ...
                                <div className="p-6">
                                    <div className="space-y-4">
                                        <div className="flex items-center justify-between">
                                            ...
                                            <Badge
                                                variant="outline"
                                                className="px-3 py-1.5 bg-blue-50 dark:bg-blue-900/20 border-blue-200 dark:border-blue-800 text-blue-700 dark:text-blue-300"
                                            >
                                                <Upload
                                                    size={12}
                                                    className="mr-1"
                                        ...
                                        <p className="text-xs text-slate-500 dark:text-slate-400">
                                            💡 Tip: You can upload any file type
                ...
                <div className="mt-6 flex items-center justify-between">
                    <div className="flex items-center space-x-6 text-sm">
                        ...
                        <div className="flex items-center space-x-2 text-slate-600 dark:text-slate-400">
                            <Wifi size={12} />
                            <span data-testid="text-device-count">
                                Auto-sync enabled
                            </span>
                        </div>
                    </div>
                ...
                <div className="grid md:grid-cols-3 gap-6 mt-12">
                    <Card className="p-6">
                        ...
                        <p className="text-sm text-slate-600 dark:text-slate-400 leading-relaxed">
                            Type once, see everywhere. Your changes appear
                            instantly on all connected devices.
                        </p>
                    </Card>
                    ...
                    <Card className="p-6">
                        ...
                        <p className="text-sm text-slate-600 dark:text-slate-400 leading-relaxed">
                            Desktop, tablet, or mobile - share code seamlessly
                    ...
                    <Card className="p-6">
                        ...
                        <p className="text-sm text-slate-600 dark:text-slate-400 leading-relaxed">
                            No login needed. Just share the URL. Your code stays
                            private and secure.
                        </p>
                    </Card>
                </div>
